...
export const FactualDetails: React.FC<FactualDetailsProps> = ({ tour }) => {
  ...
  const factualRows = [
    { label: 'Tipo de Imóvel', value: details.propertyType },
    { label: 'Área Construída / Privativa', value: `${details.builtAreaM2} m²` },
    { label: 'Área do Terreno', value: `${details.landAreaM2} m²` },
    { label: 'Dormitórios', value: `${details.bedrooms} quartos` },
    { label: 'Suítes Privativas', value: `${details.suites} suítes` },
    { label: 'Banheiros Totais', value: `${details.bathrooms} banheiros` },
    { label: 'Vagas de Garagem', value: `${details.parkingSpaces} vagas` },
    { label: 'Status da Mobília', value: details.furnishedStatus },
    { label: 'Ano de Construção', value: details.constructionYear || '2022' },
    { label: 'Taxa de Condomínio', value: details.condoFee || 'Consulte' },
    { label: 'IPTU Anual', value: details.iptu || 'Consulte' },
  ];

  return (
    <section id="details" className="py-24 md:py-32 px-6 sm:px-12 max-w-7xl mx-auto bg-[#0b0c0e]">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        {/* Left Column: SOBRE O IMÓVEL Factual Technical Sheet (7 cols) */}
